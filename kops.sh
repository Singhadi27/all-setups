...
aws s3api create-bucket --bucket devopsbyaditya02.k8s.local --region us-east-1
aws s3api put-bucket-versioning --bucket devopsbyaditya02.k8s.local --region us-east-1 --versioning-configuration Status=Enabled
export KOPS_STATE_STORE=s3://devopsbyaditya02.k8s.local
